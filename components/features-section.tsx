  ...
  const features = [
    {
      ...
      description: "Fixed APY locked at origination. No surprises, no volatility.",
    },
    {
      icon: Lock,
    ...
    },
    {
      ...
      description: "Transactions settle in seconds on the Celo blockchain.",
    },
    {
      icon: Eye,
      title: "Full Transparency",
      description: "Every transaction is on-chain and publicly verifiable.",
    },
    {
      icon: Users,
      title: "Community Governed",
      description: "Participate in protocol decisions through governance tokens.",
    },
    {
      icon: Shield,
      title: "Insurance Pool",
      description: "Optional insurance coverage for additional peace of mind.",
    },
  ]
      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="text-lg text-foreground/60 max-w-2xl mx-auto">
            Everything you need for secure, transparent, and efficient lending.
          </p>
        </motion.div>
        ...
        >
          <table className="w-full text-sm">
            ...
            <tbody>
              {[
                { feature: "Fixed Rates", celorate: true, banks: true, defi: false },
